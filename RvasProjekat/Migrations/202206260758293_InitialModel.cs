    ...
    public partial class InitialModel : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PrviModels", t => t.PrviModel_id, cascadeDelete: true)
                .ForeignKey("dbo.DrugiModels", t => t.DrugiModel_id, cascadeDelete: true)
                .Index(t => t.PrviModel_id)
                .Index(t => t.DrugiModel_id);
